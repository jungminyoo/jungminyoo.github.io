...
export const careerList = [
      ...
      careerSpecific: [
        {
          ...
          skills: [
            ...getSkills("Languages", ["C"]),
            ...getSkills("Others", ["Arduino", "Microbit"]),
          ],
        },
      ],
    },
  ...
  },
  {
    ...
    careerUrl: { url: "https://www.cassopi.io", isClosed: false },
  },
  {
    id: 4,
    KR: {
      ...
      careerSpecific: [
        {
          ...
          skills: [
            ...getSkills("Languages", ["C", "C++", "Python"]),
            ...getSkills("Others", ["Arduino", "Microbit", "EV3", "Roblox"]),
          ],
        },
      ],
    },
      ...
      careerSpecific: [
        {
          ...
          skills: [
            ...getSkills("Front-end", ["Pug", "SCSS"]),
            ...getSkills("Back-end", ["Node.js", "Express", "MongoDB"]),
            ...getSkills("Infra", ["Heroku", "AWS S3"]),
          ],
        },
      ],
    },
      ...
      careerSpecific: [
        {
          ...
          skills: [...getSkills("Front-end", ["React.js"])],
        },
      ],
    },
    EN: {
